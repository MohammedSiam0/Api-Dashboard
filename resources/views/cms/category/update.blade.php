          ...
          <form method="POST" action="{{route('categories.update',$category->id)}}">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" placeholder="{{__('cms.title')}}" name="title" value={{old('title')?? $category->title}}>
              </div>
              <div class="form-group">
                <label for="{{__('cms.description')}}">{{__('cms.description')}}</label>
                <input type="text" class="form-control" id="description" placeholder="{{__('cms.description')}}"name="description" value={{old('description')?? $category->description}}>
              </div>
              {{-- <div class="form-group">
